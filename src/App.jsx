  ...
  },
  {
    ...
    lessons:[
      { id:"m1l1", title:"The 6 Non-Negotiables Explained", dur:"10 min", type:"read",
        content:{ intro:"The CAS Humanities Non-Negotiables are not aspirational targets — they are baseline expectations for every lesson, every day, across every subject. They are grounded in the C3 Framework Inquiry Arc and our 4-day unit model: one dimension per lesson, D1 → D2 → D3 → D4.",
          sections:[
      ...
      { id:"m1l2", title:"Scenario Practice — Spot the Gap", dur:"10 min", type:"scenario",
        scenario:{ context:"You are the HOD on a walkthrough. For each lesson description, identify which Non-Negotiable is missing or inadequate.",
          cases:[
  ...
  },
  {
    ...
    lessons:[
      ...
      { id:"m3l2", title:"Subject Scenario — 5E in Economics", dur:"10 min", type:"scenario",
        scenario:{ context:"You are planning a Grade 10 Economics lesson on Scarcity (D2). Compelling question: 'Is scarcity inevitable, or is it a problem we can solve?' Work through the 5E design decisions.",
          cases:[
