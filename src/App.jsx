...
const DEFAULT_COURSES = [
  { id:"c1", name:"AP Economics", icon:"📈", desc:"College-level economics with C3 inquiry focus" },
  { id:"c2", name:"AP History", icon:"⏳", desc:"Historical thinking, sources, and argumentation" },
  { id:"c3", name:"AP Human Geography", icon:"🌍", desc:"Spatial thinking and human-environment interaction" },
  { id:"c4", name:"Civics", icon:"⚖️", desc:"Rights, power, participation, and democratic institutions" },
  { id:"c5", name:"Sociology", icon:"🏘️", desc:"Human behaviour, society, culture, and identity" },
  { id:"c6", name:"Business and Marketing", icon:"💼", desc:"Business concepts, strategy, and marketing inquiry" },
];
...
const MODULES = [
  {
    ...
    lessons:[
      { id:"m0l1", title:"Welcome to CAS Humanities", dur:"5 min", type:"read",
        content:{ intro:"Welcome to the CAS Humanities department. This onboarding module walks you through the essential routines, tools, and expectations you need to know before you step into your first lesson. Work through it at your own pace — everything here is practical and immediate.",
          sections:[
      ...
      { id:"m0l2", title:"Your Two Weekly Submissions", dur:"8 min", type:"read",
        content:{ intro:"Every teacher in the department has two fixed weekly submissions. These are non-negotiable routines — not occasional tasks. Missing them or submitting late affects the HOD's planning and is noted. This lesson explains exactly what each submission involves.",
          sections:[
  ...
  },
  {
    ...
    lessons:[
      { id:"m2l1", title:"The Inquiry Arc — Four Dimensions", dur:"12 min", type:"read",
        content:{ intro:"The C3 Framework organises all social studies learning around an Inquiry Arc — four interlocking Dimensions that take students from generating questions to communicating conclusions.",
          sections:[
      ...
      { id:"m2l2", title:"D3 Deep Dive — Source vs Evidence", dur:"10 min", type:"scenario",
        scenario:{ context:"The most common classroom failure in C3 instruction is treating sources as evidence. Work through these scenarios to sharpen the distinction.",
          cases:[
  ...
  },
  {
    ...
    lessons:[
      { id:"m3l1", title:"5E Deep Dive — Each Stage Unpacked", dur:"12 min", type:"read",
        content:{ intro:"The 5E model provides the pedagogical delivery structure for every CAS Humanities lesson. Every lesson must move through all five stages.",
          sections:[
            { icon:"🔥", heading:"ENGAGE (0–7 min) — Ignite Curiosity", body:"A hook that activates prior knowledge and creates cognitive readiness. Strong hooks: a single powerful image, a contradictory statistic, a provocative quotation. The teacher ends Engage with the compelling question visible and framed.", key:{ label:"What Engage Is NOT", text:"Engage is not the teacher explaining what students will learn today. It is specifically designed to create curiosity about today's intellectual focus." }},
            { icon:"🔬", heading:"EXPLORE (7–19 min) — Students Construct First", body:"Students work with content before receiving formal explanations. This is the key inversion of traditional instruction. Students encounter a concept or scenario and begin to make sense of it. The teacher facilitates but does not explain.", key:{ label:"The Golden Rule of Explore", text:"If the teacher is talking more than students during Explore, something has gone wrong. Student talk should dominate this stage." }},
            { icon:"💡", heading:"EXPLAIN (19–29 min) — Formalise and Clarify", body:"Now the teacher explains, formalises, and addresses misconceptions surfaced during Explore. This builds on what students discovered. Duration: 8-10 minutes maximum." },
            { icon:"🌍", heading:"ELABORATE (29–39 min) — Apply to New Context", body:"Students apply the concept to a new or extended scenario. In C3 lessons, Elaborate always connects back to the compelling question.", key:{ label:"Subject Examples", text:"Economics: Apply opportunity cost to a budget. History: Apply perspective to a new source. Geography: Apply interaction to a different region." }},
            { icon:"📋", heading:"EVALUATE (39–45 min) — Check for Understanding", body:"Every lesson ends with a formative check that shapes tomorrow's planning.", key:{ label:"Strong Exit Ticket Formula", text:"'Use [concept] to [do something specific] in response to [compelling question].' This gives specific diagnostic data." }},
          ]
        }
      },
      { id:"m3l2", title:"Subject Scenario — 5E in Economics", dur:"10 min", type:"scenario",
        scenario:{ context:"You are planning a Grade 10 Economics lesson on Scarcity (D2). Compelling question: 'Is scarcity inevitable, or is it a problem we can solve?'",
          cases:[
            { setup:"You need to design the ENGAGE stage. You have 7 minutes.", question:"Which Engage activity best meets the 5E standard?", options:[{ label:"A", text:"Teacher writes the definition of scarcity on the board"},{ label:"B", text:"Teacher displays images: food bank, empty shelf, water scarcity graph. Ask: 'What do these have in common?'"},{ label:"C", text:"Students complete a 10-question quiz"},{ label:"D", text:"Teacher plays a 5-minute video explaining scarcity"}], correct:1, feedback:"Option B is the strongest Engage. It provokes curiosity before receiving the concept name and connects to the compelling question." },
            { setup:"For EXPLORE, students work through a Desert Island scenario to allocate resources.", question:"What is the teacher's correct role during the Explore stage?", options:[{ label:"A", text:"Stand at the front and give hints"},{ label:"B", text:"Circulate, listen, ask probing questions, but do NOT explain scarcity yet"},{ label:"C", text:"Sit at the desk independently"},{ label:"D", text:"After 5 minutes, pause and explain opportunity cost"}], correct:1, feedback:"Option B is correct. The teacher is a facilitator, not an instructor, during Explore." },
          ]
        }
      },
      { id:"m3l3", title:"5E Mastery Quiz", dur:"6 min", type:"quiz",
        questions:[
          { q:"Which stage of the 5E model should have the MOST student talk?", sub:"", opts:["Engage","Explore","Explain","Elaborate"], correct:1, explain:"Explore is the student-led discovery stage. If the teacher is talking more than students, the stage has been converted back into a mini-lecture." },
          { q:"A teacher's Explain stage runs for 22 minutes. What is the consequence?", sub:"", opts:["More learning occurs","The Elaborate and Evaluate stages are compressed or eliminated","Students appreciate the thoroughness","The structure becomes stronger"], correct:1, explain:"A 22-minute Explain consumes Elaborate and Evaluate time. Students never apply the concept or have understanding checked." },
          { q:"What makes an exit ticket genuinely formative?", sub:"", opts:["It must be written","It must produce specific, actionable information about what students understood","Any question at the end counts","It must take at least 5 minutes"], correct:1, explain:"It must provide diagnostic data that enables the teacher to identify gaps and plan accordingly." },
        ]
      },
    ]
  },
  {
    ...
    desc:"Apply C3 and 5E to your specific subject — content adapts to your assigned courses.",
    lessons:[
      ...
      { id:"m4l3", title:"Lesson Planning and Template Quiz", dur:"8 min", type:"quiz",
        questions:[
          { q:"The 'Chapter/Unit/Lesson' field in the CAS template should contain which info?", sub:"", opts:["Chapter number only","Unit title, lesson number (e.g. Day 2 of 4), and C3 Dimension","Teacher name and date","Learning objective restated"], correct:1, explain:"This communicates the unit context to any reader and shows where the lesson sits in the inquiry arc." },
          { q:"Is a Learning Intention that says 'Students will understand the concept' valid?", sub:"", opts:["Yes — states topic","No — 'understand' is not observable. LI states what students will be ABLE TO DO","Yes — understanding is the goal","No — needs more detail"], correct:1, explain:"A Learning Intention must describe observable student behaviour like 'explain', 'construct', or 'argue'." },
          { q:"In the Lesson Cycle section, bullet points should describe…", sub:"", opts:["What teacher says","What STUDENTS will do at each stage — specific actions","Timing of activity","Resources used"], correct:1, explain:"The Lesson Cycle section is student-focused. Every bullet should begin with 'Students will...'" },
          { q:"Which D3 exit ticket option is strongest?", sub:"", opts:["Names of three sources","Credibility rating","Claim, citation, and explanation of support","Summary of what source said"], correct:2, explain:"Strongest exit tickets require the full evidence relationship: claim + source + explicit connection." },
        ]
      },
    ]
  },
  {
    ...
    desc:"The six baseline standards every Humanities lesson must meet — grounded in C3 and 4-day inquiry.",
    lessons:[
      { id:"m1l1", title:"The 6 Non-Negotiables Explained", dur:"10 min", type:"read",
        content:{ intro:"The CAS Humanities Non-Negotiables are baseline expectations for every lesson. They are grounded in the C3 Framework Inquiry Arc and our 4-day unit model: D1 → D2 → D3 → D4.",
          sections:[
            { icon:"❓", heading:"NN1 — Compelling Question Anchors the Unit", body:"Every unit is built around one compelling question. It must be displayed in every lesson, referenced at the start, and returned to at the end.", key:{ label:"Why It Matters", text:"Without a driving question, students complete disconnected tasks rather than a 4-day inquiry that builds a real argument." }},
            { icon:"📐", heading:"NN2 — One C3 Dimension Per Lesson (4-Day Model)", body:"Every unit spans exactly four lessons: D1 (Questions), D2 (Concepts), D3 (Sources), D4 (Conclusions). No dimension is skipped.", key:{ label:"Critical Principle", text:"Each dimension deserves a full 45-minute lesson. Rushing D3 into D2 is a common planning failure." }},
            { icon:"⚙️", heading:"NN3 — 5E Structure Within Every Lesson", body:"Within each dimension-lesson, the 5E model must be followed. 5E is the lesson structure; C3 is the unit structure.", key:{ label:"Key Principle", text:"Ensures every 45-minute lesson has a complete learning cycle where students explore before the teacher explains." }},
            { icon:"💬", heading:"NN4 — Evidence-Based Student Talk Every Lesson", body:"Students must speak in every lesson, using at least one structured discussion where they support claims with evidence.", key:{ label:"Acceptable Formats", text:"Socratic seminar, academic controversy, think-pair-share with evidence, expert jigsaw, D4 peer argumentation." }},
            { icon:"🎯", heading:"NN5 — Differentiation is Planned for All 5 Groups", body:"Every lesson plan must include explicit differentiation for SEN, LA, MA, HA, and G&T students across all four dimension-lessons.", key:{ label:"Critical Distinction", text:"In the 4-day model, differentiation must be planned per dimension and be a genuine modification." }},
            { icon:"📊", heading:"NN6 — Formative Assessment Closes Every Lesson", body:"Every lesson must close with a check aligned to the day's C3 dimension.", key:{ label:"The Test", text:"Exit tickets must be dimension-specific. 'Write one thing you learned' fails NN6." }},
          ]
        }
      },
      { id:"m1l2", title:"Scenario Practice — Spot the Gap", dur:"10 min", type:"scenario",
        scenario:{ context:"Identify which Non-Negotiable is missing or inadequate in these classroom walkthroughs.",
          cases:[
            { setup:"Ms. Karimi runs D1 and D2 in the same lesson. D3 and D4 are combined in the next.", question:"Which Non-Negotiable is clearly violated?", options:[{ label:"A", text:"NN1 — No compelling question"},{ label:"B", text:"NN2 — The 4-day model is violated; dimensions are compressed"},{ label:"C", text:"NN4 — No student talk"},{ label:"D", text:"NN3 — 5E missing"}], correct:1, feedback:"Correct. NN2 is violated. Each C3 dimension must receive a full 45-minute lesson." },
            { setup:"Mr. Al-Farsi's D3 exit ticket is 'Write names of three sources used today.'", question:"Which Non-Negotiable is weakest?", options:[{ label:"A", text:"NN6 — Exit ticket doesn't evaluate sources or use them as evidence"},{ label:"B", text:"NN1 — Question not visible"},{ label:"C", text:"NN5 — No differentiation"},{ label:"D", text:"NN2 — Sources missing"}], correct:0, feedback:"Correct. NN6 is violated. D3 exit tickets must ask students to use a source as evidence." },
          ]
        }
      },
      { id:"m1l3", title:"Non-Negotiables Mastery Quiz", dur:"8 min", type:"quiz",
        questions:[
          { q:"How many lessons does one C3 unit span at CAS Humanities?", sub:"", opts:["2 lessons","4 lessons — one per C3 dimension","5 lessons","6 lessons"], correct:1, explain:"The CAS model gives each C3 dimension (D1-D4) a full 45-minute lesson." },
          { q:"What does identical differentiation for all groups violate?", sub:"", opts:["NN3","NN5 — no genuine differentiation planned","NN6","NN1"], correct:1, explain:"NN5 requires genuine modification per group across all four dimension-lessons." },
          { q:"Which is a valid D1 exit ticket?", sub:"", opts:["One thing learned","Name three sources","Write one supporting question to answer compelling question","Lesson rating"], correct:2, explain:"A D1 exit ticket must produce a student-generated supporting question to test if they can break down the compelling question." },
          { q:"In a D2 lesson, the 5E Explore stage requires…", sub:"", opts:["Teacher explains first","Students grapple with concept BEFORE formal explanation","20 mins group work","Written task"], correct:1, explain:"Explore comes before Explain. Students must encounter and wrestle with the concept before receiving the formal definition." },
        ]
      },
    ]
  },
...
const SUBJECT_CONTENT = {
  c1:{lens:{intro:"You teach Economics. C3 D2 is built around the concepts economists use to analyse decisions, markets, and systems.",sections:[
  ...
  ]},scenario:{context:"Apply C3 planning to an Economics unit from start to finish.",cases:[
  ...
  c2:{lens:{intro:"You teach History. C3 D2 is built around historical thinking concepts — the tools historians use to construct meaning from the past.",sections:[
  ...
  ]},scenario:{context:"Apply C3 planning to a History unit from start to finish.",cases:[
  ...
  c3:{lens:{intro:"You teach Geography. C3 D2 is built around geographic thinking concepts — the ways geographers interpret spatial patterns, human-environment relationships, and global connections.",sections:[
  ...
  ]},scenario:{context:"Apply C3 planning to a Geography unit from start to finish.",cases:[
  ...
  c4:{lens:{intro:"You teach Civics. C3 D2 is built around civic concepts — the ideas and structures through which power is organised, rights are protected, and citizens participate.",sections:[
  ...
  ]},scenario:{context:"Apply C3 planning to a Civics unit from start to finish.",cases:[
  ...
  c5:{lens:{intro:"You teach Sociology. C3 D2 is built around sociological concepts — the frameworks sociologists use to understand how society shapes individuals and how individuals shape society.",sections:[
  ...
  ]},scenario:{context:"Apply C3 planning to a Sociology unit from start to finish.",cases:[
  ...
  c6:{lens:{intro:"You teach Business and Marketing. C3 D2 is built around business and marketing concepts — the frameworks used to analyse organisations, markets, and decisions.",sections:[
  ...
  ]},scenario:{context:"Apply C3 planning to a Business and Marketing unit from start to finish.",cases:[
...
function AiChat({ systemPrompt, placeholder, title, accentColor = "var(--ink2)" }) {
  ...
  return (
    <>
      ...
      {open && (
        <div style={{ marginTop:12, background:"var(--card)", border:`2px solid ${accentColor}`,
          ...
          <div style={{ height:320, overflowY:"auto", padding:"14px 16px", display:"flex", flexDirection:"column", gap:10, background:"#F8FAFD" }}>
            ...
            {msgs.map((m, i) => (
              <div key={i} style={{ display:"flex", justifyContent: m.role==="user" ? "flex-end" : "flex-start" }}>
                <div style={{ maxWidth:"82%", padding:"9px 13px", borderRadius: m.role==="user" ? "12px 12px 3px 12px" : "12px 12px 12px 3px",
          ...
          <div style={{ display:"flex", gap:8, padding:"10px 12px", borderTop:"1px solid var(--border)", background:"#fff" }}>
            <input value={input} onChange={e => setInput(e.target.value)}
              ...
              style={{ flex:1, padding:"9px 12px", border:"2px solid var(--border)", borderRadius:8, fontSize:13,
                color:"var(--ink)", outline:"none", fontFamily:"'Outfit',sans-serif" }}
              disabled={busy}/>
            <button onClick={send} disabled={busy || !input.trim()}
              style={{ padding:"9px 16px", background:accentColor, color:"#fff", border:"none",
            ...
            {filtered.map((r, i) => (
              <div key={i} style={{ border:"1px solid var(--border)", borderRadius:10, overflow:"hidden", margin:"0 16px" }}>
                <div onClick={() => setOpen(open === i ? null : i)}
                  ...
                  <div style={{ width:36, height:36, borderRadius:"50%", background:"#EAF2FF",
...
function TeacherTrainingPortal({ teachers, saveTeachers, courses, notify }) {
  ...
  const markDone = async (lessonId) => {
    ...
    notify("✓ Lesson complete — progress saved!");
  };
      ...
      <div>
        ...
        <div style={{ background:"var(--card)", borderRadius:14, boxShadow:"var(--sh)", overflow:"hidden" }}>
          ...
          <div style={{ padding:"22px 28px 18px", borderBottom:"2px solid var(--border)" }}>
            <div style={{ display:"inline-block", padding:"3px 11px", borderRadius:99, fontSize:11, fontWeight:700,
          ...
          <div style={{ padding:"26px 28px" }}>
            {lesson.type === "read" && lesson.content && (
              <div>
                <div style={{ background:"var(--sky-pale)", borderLeft:"4px solid var(--ink2)", padding:"13px 16px",
                ...
                {lesson.content.sections && lesson.content.sections.map((s, i) => (
                  <div key={i} style={{ marginBottom:22 }}>
                    <h4 style={{ fontSize:13, fontWeight:700, color:"var(--ink2)", marginBottom:7,
            ...
            {isDone && (nextLesson || nextMod) && (
              <div style={{ marginTop:16, padding:"12px 16px", background:"var(--sky-pale)", borderRadius:9,
    ...
    <div>
      ...
      <div style={{ display:"flex", flexDirection:"column", gap:12 }}>
        {MODULES.map(mod => {
          ...
          return (
            <div key={mod.id} style={{ background:"var(--card)", borderRadius:14, boxShadow:"var(--sh)",
      ...
      {totalPct === 100 && (
        <div style={{ marginTop:20, background:"linear-gradient(135deg,var(--ink2),var(--orange))", borderRadius:12,
...
function CoursesByGrade() {
  ...
  return (
    <div style={{ display:"flex", flexDirection:"column", gap:20 }}>
      {GRADES.map(g => (
        <div key={g.grade} style={{ background:"var(--card)", borderRadius:16, padding:"28px 32px",
            ...
            {g.courses.map(c => {
              ...
              return (
                <div key={c.name} style={{ display:"flex", flexDirection:"column", gap:0 }}>
                  ...
                  {isOpen && c.about && (
                    <div style={{ background:tc.bg, border:`1px solid ${tc.border}`, borderTop:"none",
...
function HomeDeptPage() {
  return (
    <div style={{ fontFamily:"'Outfit',sans-serif" }}>
      ...
      {/* ── HERO ── */}
      <div style={{ background:"linear-gradient(135deg,#0A0A2E 0%,#1A1060 40%,#3D1A8C 70%,#6B2FA0 100%)",
        ...
        <h1 style={{ fontFamily:"'Playfair Display',serif", fontSize:52, fontWeight:900, color:"#fff",
        ...
        <div style={{ display:"flex", gap:12, justifyContent:"center", flexWrap:"wrap" }}>
          <a href="#courses" onClick={e=>{e.preventDefault();document.getElementById("courses")?.scrollIntoView({behavior:"smooth"})}} style={{ display:"inline-flex", alignItems:"center", gap:8, padding:"13px 26px",
          ...
          <a href="#programs" onClick={e=>{e.preventDefault();document.getElementById("programs")?.scrollIntoView({behavior:"smooth"})}} style={{ display:"inline-flex", alignItems:"center", gap:8, padding:"13px 26px",
      ...
      <div id="faculty" style={{ paddingBottom:64 }}>
        ...
        <div style={{ display:"grid", gridTemplateColumns:"repeat(3,1fr)", gap:20 }}>
          {FACULTY.map(f => (
            <div key={f.name} style={{ background:"var(--card)", borderRadius:16, padding:"28px 24px",
              boxShadow:"0 2px 16px rgba(10,31,68,.07)", border:"1px solid var(--border)", textAlign:"center" }}>
              {/* Avatar circle */}
              <div style={{ width:72, height:72, borderRadius:"50%", background:`${f.roleColor}22`,
              ...
              <div style={{ borderTop:"1px solid var(--border)", paddingTop:12, display:"flex", flexDirection:"column", gap:5 }}>
                <a href={`mailto:${f.email}`} style={{ fontSize:12, color:"var(--ink2)", textDecoration:"none",
      ...
      <div id="programs" style={{ paddingBottom:64 }}>
        ...
        <div style={{ display:"grid", gridTemplateColumns:"repeat(3,1fr)", gap:20 }}>
          {PROGRAMS.map(p => (
            <div key={p.name} style={{ background:"var(--card)", borderRadius:16, padding:"28px 24px",
              boxShadow:"0 2px 16px rgba(10,31,68,.07)", border:"1px solid var(--border)" }}>
              <div style={{ width:52, height:52, borderRadius:"50%", background:p.bg,
...
function AdminDash({ teachers, saveTeachers, courses, saveCourses, notify }) {
  ...
  const addTeacher = () => {
    ...
    if (editTeacher) {
      saveTeachers(teachers.map(t => t.id===editTeacher.id ? { ...t, name:teacherForm.name.trim(), subject:teacherForm.subject, role:teacherForm.role, email:teacherForm.email.trim(), courses:teacherForm.courses } : t));
      notify("✓ Teacher updated");
    } else {
      const nt = { id:"t"+Date.now(), name:teacherForm.name.trim(), subject:teacherForm.subject, role:teacherForm.role, email:teacherForm.email.trim(), joined:new Date().toLocaleDateString("en-GB",{month:"short",year:"numeric"}), courses:teacherForm.courses, progress:{ m1:0, m2:0, m3:0, m4:0 }};
      saveTeachers([...teachers, nt]);
  ...
  const addCourse = () => {
    ...
    if (editCourse) {
      saveCourses(courses.map(c => c.id===editCourse.id ? { ...c, ...courseForm } : c));
      notify("✓ Course updated");
    } else {
      saveCourses([...courses, { id:"c"+Date.now(), ...courseForm }]);
      notify("✓ Course added");
    }
      ...
      {adminTab==="courses" && (
        <div className="panel">
          <div className="panel-hd">
            ...
            <button className="add-btn" onClick={() => { setCourseForm({ name:"", icon:"📚", desc:"" }); setEditCourse(null); setShowCourseModal(true); }}>+ Add Course</button>
          </div>
            ...
            {courses.map(c => (
              <div key={c.id} className="course-card">
                <div className="course-card-hd">
                  ...
                  <div style={{ display:"flex", gap:5 }}>
                    <button style={{ padding:"3px 9px", border:"1px solid var(--border)", background:"var(--sky-pale)", color:"var(--ink2)", borderRadius:6, fontSize:11, fontWeight:700, cursor:"pointer" }} onClick={() => { setCourseForm({ name:c.name, icon:c.icon, desc:c.desc }); setEditCourse(c); setShowCourseModal(true); }}>Edit</button>
